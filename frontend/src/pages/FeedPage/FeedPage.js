              ...
              <nav id="sidebar">
                <div className="content">
                  <ul class="list-unstyled">
                    <li class="activesb">
                      <a onClick={() => handleClick("Feed")}>
                        <i class="bi bi-rss icon-theme"></i>Feed
                      </a>
                    </li>
                    <li>
                      <a onClick={() => handleClick("FindCreators")}>
                        <i class="bi bi-people-fill icon-theme"></i>Find
                        Creators
                      </a>
                    </li>
                    <li>
                      <a onClick={() => handleClick("Favourite")}>
                        <i class="bi bi-star icon-theme"></i>Favourits
                      </a>
                    </li>
                    <li>
                      <a onClick={() => handleClick("Chat")}>
                        <i class="bi bi-chat-dots icon-theme"></i>Chat
                      </a>
                    </li>
                    <li>
                      <a onClick={() => handleClick("Statics")}>
                        <i class="bi bi-graph-up icon-theme"></i>Statics
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a onClick={() => handleClick("Advertisment")}>
                        <i class="bi bi-badge-ad-fill icon-theme"></i>
                        Advertisment
                      </a>
                    </li>
                  </ul>
